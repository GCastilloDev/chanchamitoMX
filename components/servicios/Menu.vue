<template>
  <div class="columns buttons">
    <button
      class="button column has-text-centered is-link"
      @click="$emit('change', 'Marketing')"
    >
      <div>
    ...
    <div
      class="column has-text-centered is-link"
      @click="$emit('change', 'IT')"
    >
      <div>
        <figure class="image is-64x64 is-inline-block">
          <img src="../../assets/desarrollo-de-aplicaciones.svg" />
        </figure>
      </div>
      <div>Servicios en T.I.</div>
    </div>
  </div>
</template>
